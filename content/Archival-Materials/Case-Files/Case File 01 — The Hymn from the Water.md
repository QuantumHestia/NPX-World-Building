---
title: "Case File 01 — The Hymn from the Water"
type: record
record_type: case_file
status: archived
where: "The Summer Isles — Tidemark Outer Docks"
date: "Cycle 1, Phase 6 — Late Monsoon Season"
...
> **Read this file before dusk.**
> Not because the paper is dangerous—because *you are*.
> The sea does not need your faith to take you. Only your attention.
...
> [!archivist-note-left]
> The archive keeps a catalogue of deaths.
> What unsettles me is not the drowning—drownings are common here.
> It is the manner of the step: not panic, not drunkenness, not grief.
> 
> As if obedient.
...
> [!archivist-note-right]
> If you wish to understand why the Archive fears certain songs:
> A blade can kill you.
> A song can persuade you to kill yourself whilst believing you have chosen comfort.
...
> [!archivist-note-left]
> I must apologize; I dislike this aspect of my work.
> Redaction feels like lying.
> But at times, lying is a must. A protective measure. 
> There are lies that protect, and there are truths that function like hooks.
...
1) **Attention escalates compulsion.** The hymn strengthens when a listener becomes still, quiet, and receptive.  
2) **Crowds accelerate spread.** Not by volume—by repetition of reaction. A glance, a pause, a hush. Recognition multiplies.
...
1) speak the victim’s name clearly and repeatedly,
2) maintain physical contact (wrist/forearm preferred),
3) force gaze away from open water—lantern flame works best.
...
One went silent mid-verse and stepped into the water smiling.
The other finished the song perfectly and could not speak for three days.
...
- [[The-Unified-Theory-of-the-Weave|The Unified Theory of the Weave]] — recognition pressure and settlement
